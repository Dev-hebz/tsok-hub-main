      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 flex items-center justify-center p-4">
        ...
        >
          <div className="text-center mb-8">
            <Image src="/tsok-logo.png" alt="TSOK" width={80} height={80} className="mx-auto mb-4" />
            <h1 className="text-2xl font-bold text-white">Admin Panel</h1>
            <p className="text-blue-200 text-sm mt-1">TSOK Portal Management</p>
          </div>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-yellow-400 text-blue-900 font-bold rounded-xl hover:bg-yellow-300 transition-colors text-lg"
            >
              Login
            </button>
          </form>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Manage websites & members</p>
              </div>
            </div>
            <div className="flex gap-3">
              <Link href="/" className="px-4 py-2 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors text-sm">
                View Site
              </Link>
              <Link href="/feed" className="px-4 py-2 bg-yellow-400 text-blue-900 rounded-lg font-bold hover:bg-yellow-300 transition-colors text-sm">
                Community
              </Link>
              <button
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-white mb-2 font-semibold">
                        Icon URL <span className="text-blue-300 text-sm font-normal">(Optional)</span>
                      </label>
                      <input
                        type="url"
                        value={formData.icon}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2 rounded-lg bg-blue-900 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-yellow-400"
                      >
